...
function withCORS(headers, request) {
  ...
  if (typeof(request.corsAnywhereRequestState.allowCredentials) !== 'undefined' && request.corsAnywhereRequestState.allowCredentials === true && typeof(request.headers['origin']) !== 'undefined') {
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    if (typeof(req.headers['origin']) === 'undefined') req.headers['origin']="localhost";
